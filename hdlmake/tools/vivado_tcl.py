...
"""Module providing support for Xilinx Vivado Tcl Flow"""
...
class ToolVivadoTcl(ToolXilinx):
    ...
    def __init__(self):
        super(ToolVivadoTcl, self).__init__()
        self._tcl_controls.update(ToolVivadoTcl.TCL_CONTROLS)
