    ...
    def __init__(self):
        ...
        syn_options = [
            ...
            {'name': 'syn_path',
             ...
             'type': ''},
            {'name': 'syn_device_prefix',
             'default': None,
             'help': "Target FPGA device prefix",
             'type': ''},
            {'name': 'syn_device',
             'default': None,
            ...
            {'name': 'syn_family',
             ...
             'type': ''},
            {'name': 'syn_family_surfix',
             'default': None,
             'help': "Target FPGA family surfix",
             'type': ''},
            {'name': 'syn_grade',
             'default': None,
            ...
            {'name': 'syn_elab_param',
             'default': {},
             'help': "Elaborate options for the design",
             'type': {}},
